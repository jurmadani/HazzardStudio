...
export const checkCreditCard = (cardnumber: string | number | any) => {
    ...
    //Error messages
    const ccErrors = [];
    ccErrors[0] = "Tip de card necunoscut";
    ccErrors[1] = "Nu a fost furnizat niciun număr de card";
    ccErrors[2] = "Numărul de card de credit are un format invalid";
    ccErrors[3] = "Numărul de card de credit este invalid";
    ccErrors[4] = "Numărul de card de credit are un număr inadecvat de cifre";
    ccErrors[5] = "Atenție! Acest număr de card de credit este asociat cu o încercare de înșelăciune";
